...
using NzApp.Data;
using NzApp.Mappings;
using NzApp.Middlewares;
...
namespace NzApp
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContextPool<NZWalksDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("DefaultConnection")));
